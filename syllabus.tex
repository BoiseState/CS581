...
(e.g., Claude Code, Codex, or equivalent) to design, build,
...
\begin{itemize}
    ...
    \item \textbf{Author's website (every chapter, free):} \href{https://www.cl.cam.ac.uk/archive/rja14/book.html}{cl.cam.ac.uk/archive/rja14/book.html} --- Anderson posts the full text of both the 2nd and 3rd editions as free chapter PDFs. This is the fastest option and it is author-sanctioned.
    \item \textbf{Which edition:} either works. Chapter \emph{numbers} differ between editions, so this course gives both. Where they differ, the 3rd edition number is listed first.
\end{itemize}
...
and apply each subsequent workshop to a chosen system. Workshop 1 (60 points) includes
the system selection, sequencing plan, and attack surface map; Workshops 2--9 are 30 points each.
The sequencing plan ensures all eleven systems appear in the portfolio by Week 14.}
...
\midrule
Workshop 1 (System Selection,\newline Sequencing Plan \& Attack Surface Map) & 60 \\
Workshops W2--W9 (8 $\times$ 30~pts) & 240 \\
...
%------------------------------------------------------------
\section*{Artificial Intelligence Use Policy}
%------------------------------------------------------------

\textbf{AI use is required in this course.} CS 581 treats AI Coding Assistants as a
primary professional tool, not a convenience or shortcut. Every workshop requires
students to use an AI Coding Assistant (e.g., Claude Code or Codex)
to design, build, and iterate on security artifacts. AI tool use is evaluated as
a graded component of every workshop submission.

\medskip

\textbf{Session logs are mandatory.} Every graded submission must be accompanied
by a session log documenting the AI interactions that produced it. Logs must include
actual prompts, representative outputs, and honest reflection on what worked and
what did not. Submitting AI-assisted work without a session log is an academic
integrity violation.

\medskip

\textbf{You are accountable for every claim.} AI tools make errors --- including
confident, specific, technically plausible errors. You are responsible for
verifying every factual claim, protocol reference, and regulatory citation in your
submissions. If an AI tool produces an error and you do not catch it, that error
is yours. The session log is where you document how you caught and corrected
AI mistakes; this is explicitly graded.

\medskip

\textbf{Tool requirements.} Use only US-based AI providers with documented data
handling policies. This is a nuclear cybersecurity course; the appropriateness of
your tool choice is itself a professional judgment you are expected to make and
defend. Three vetted options are listed under Required Software above.

\medskip

\textbf{Written assignments.} The Midterm Scenario Exercise and Ethics Paper may
be researched, outlined, and drafted with AI assistance. Session logs are required.
You must be able to defend every source and every claim in a follow-up discussion.
