...
Relevant chapters are freely available at \href{https://www.cl.cam.ac.uk/~rja14/book.html}{https://www.cl.cam.ac.uk/\textasciitilde rja14/book.html}
...
\smallskip
\textbf{Written Assignments} \\
\textit{Ethics paper and one final written analysis, each grounded in primary sources.}
...
\textit{Semester-long deliverable on a student-selected topic; presented asynchronously in Week 15.}
...
\textit{Open-context nuclear incident scenario at Week 10; students produce a full response package.}
\end{minipage}%
\hfill
...
Workshops \& Coding Assignments & 300 \\
Project \& Presentation & 200 \\
...
\textbf{Submission} \\
\textit{All assignments must be pushed to the student's course GitHub repository
by 11:59pm MT on the due date.} Late submissions are subject to the following
progressive penalty:
